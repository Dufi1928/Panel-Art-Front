...
export default function EditIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="editIcon">
            <g clipPath="url(#clip0_346_405)">
                <path
                ...
                <path
                    d="M21.8799 3.56C20.6499 6.63 17.5599 10.81 14.9799 12.88L13.3999 14.14C13.1999 14.29 12.9999 14.41 12.7699 14.5C12.7699 14.35 12.7599 14.2 12.7399 14.04C12.6499 13.37 12.3499 12.74 11.8099 12.21C11.2599 11.66 10.5999 11.35 9.91994 11.26C9.75994 11.25 9.59994 11.24 9.43994 11.25C9.52994 11 9.65994 10.77 9.82994 10.58L11.0899 9C13.1599 6.42 17.3499 3.31 20.4099 2.08C20.8799 1.9 21.3399 2.04 21.6299 2.33C21.9299 2.63 22.0699 3.09 21.8799 3.56Z"
                    stroke="#5D5A88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path
                    ...
                    stroke="#5D5A88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M15.8198 11.98C15.8198 9.89 14.1298 8.19 12.0298 8.19" stroke="#5D5A88" strokeWidth="1.5"
                      strokeLinecap="round" strokeLinejoin="round"/>
            </g>
            <defs>
                <clipPath id="clip0_346_405">
